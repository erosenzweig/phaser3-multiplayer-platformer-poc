...
** @description
** GamePad.js
** modified by me to 12/27/2021 to include event emitting
*/
    ...
    var events = {
      on:function(eventName, callback) {
        if(customEvents[eventName]) {
            customEvents[eventName].push(callback);
        } else {
      ...
      trigger:function(eventName, ...params) {
        if(customEvents[eventName]) {
            customEvents[eventName].forEach(cb => cb.apply(null, params));
        }
      },
      bind:function()
      {
        ...
        ev = document.querySelector('.touch').style.display === '' ? ev.app : ev.browser;
        for(var e in ev)
        {
